...
function QuestHelper_ErrorCatcher.OnError(o_msg, o_frame, o_stack, o_etype, ...)
  if o_msg and
    ...
    and not string.match(debugstack(2, 20, 20), "QuestHelper\\AstrolabeQH\\DongleStub.lua") -- We're catching errors caused by other people mucking up their dongles. Ughh.
    then
