...
QuestHelper_Translations.nlNL =
 {
  ...
  ZONE_LAYOUT_ERROR = "Je gebruikt een oude versie van QuestHelper. Je zult moeten updaten op http://www.quest-helper.com om het te blijven gebruiken. Je gebruikt momenteel versie %1.",
  ...
  PLEASE_SUBMIT = "%h(QuestHelper heeft jouw hulp nodig!) Als je even tijd hebt, ga dan naar de QuestHelper website %h(http://www.quest-helper.com) en volg de instrcuties om je verzamelde data in te sturen. Jouw data helpt om QuestHelper werkend en up-to-date te houden. Alvast bedankt!",
