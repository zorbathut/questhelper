...
QuestHelper_Translations.elEL =
 {
  ...
  ZONE_LAYOUT_ERROR = "Αρνούμαστε να εκτελέσουμε την εφαρμογή από φόβο μην αλλοιωθούν τα σωσμένα δεδομένα σας.Παρακαλώ αναμείνατε για μία ανανέωση που θα μπορεί να σας οδηγήσει στην νέα ζώνη.",
  ...
  PLEASE_RESTART = "Ένα λάθος συναίβει στην έναρξη του βοηθού αποστολών.Επανεκκινήστε το παιχνίδι παρακαλώ πολά και ξαναδοκιμάστε.",
