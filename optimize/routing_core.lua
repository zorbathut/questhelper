...
-- Configuration
   PheremonePreservation = 0.85 -- must be within 0 and 1 exclusive
   AntCount = 20 -- number of ants to run before doing a pheremone pass

  -- Weighting for the various factors
   WeightFactor = 1.35
   DistanceFactor = -0.6
   DistanceDeweight = 0.8 -- Add this to all distances to avoid sqrt(-1) deals
