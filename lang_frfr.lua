...
QuestHelper_Translations.frFR =
 {
  ...
  HOME_NOT_KNOWN = "Vous n'avez pas d'auberge définie. Lors d'une prochaine visite à votre aubergiste; réinitialisez-là.",
  ...
  INACCESSIBLE_OBJ = "QuestHelper n'a pas été capable de trouver une destination pour %h1. Nous avons ajouté une destination impossible à rejoindre dans la liste d'objectifs. Si vous trouvez une version utile de cet objet, soumettez vos données!",
  ...
  HIDDEN_NONE = "Il n'y a aucun objectif caché par l'utilisateur",
  ...
  FILTERED_UNWATCHED = "Filtré car l'objectif n'est pas suivi dans le journal de quête",
  FILTERED_USER = "Vous avez demandé de caché cet objectif.",
  ...
  MENU_TRACKER_OPTIONS = "Suivi de quête",
  ...
  MENU_TRACKER_RESET = "Réinitialiser position du compas",
  MENU_FLIGHT_TIMER = "%1 Temps de vol",
  MENU_ANT_TRAILS = "%1 Traces de pas",
  MENU_WAYPOINT_ARROW = "%1 Compas",
  ...
  MENU_PERFORMANCE = "Charge de travail de calcul de la route",
  MENU_LOCALE = "Langue",
  MENU_PARTY = "Groupe",
