...
QuestHelper_Translations["huHU"] =
 {
  ...
  OBJECTIVE_REASON = "%1 %h2-t a(z) %h3 queshez.", -- %1 is a verb, %2 is a noun (item or monster)
  ...
  DEPENDS_ON_SINGLE = "Ettől fögg: '%1'.",
  ...
  QH_BUTTON_HIDE = "Rejtése",

  MENU_CLOSE = "%h(Menü Bezárása)",
  MENU_SETTINGS = "Beállítások",
  MENU_ENABLE = "Kapcsold be",
  MENU_DISABLE = "Kapcsold ki",
  ...
  MENU_TRACKER_RESET = "Elhalyezésének Visszaállítása",
